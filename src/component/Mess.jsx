...
console.log(x)
    ...
    <h2 className=" text-3xl fixed top-[1vh] left-[30vw] font-semibold ">Chatting Website</h2>
...
{x.map((i)=>(<>
    <div class="bg-blue-100  flex h-[auto] text-md flex-row p-3 gap-1 rounded-sm shadow-inner ">
            ...
            <p className=" text-blue-900 relative w-[65vw] bg-blue-100 translate-x-[-12vw] translate-y-[1vh] m-1 writing-mode-vertical-rl text-orientation-mixed break-words h-[auto] text-lg font-semibold">{i.message}</p>
            <div className=" flex flex-col gap-0 absolute left-[70vw] h-5 scale-[0.8]">
